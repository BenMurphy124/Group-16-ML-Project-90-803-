...
public class QuickSort {
    ...
    private static void quickSort(int[] unsorted, int left, int right) {
        ...
        // and get position (index) of the pivot value
     ...
     * @return the index of the pivot value after the pivot value is inserted into its final position
     */
