...
public class MaxHeap implements MaxHeapInterface {
    ...
    public boolean insert(int key) {
        ...
        // then restore the heap-order property
    ...
    private void percolateUp(int index) {
        ...
        // and put the bottom node into the right position
    ...
    public int removeMax() {
        ...
        currentSize = currentSize - 1;
        // first things first: make sure the heap is complete
    ...
    private void percolateDown(int index) {
        ...
        while (index < (currentSize / 2)) {
            ...
            // and then compare left and right to find larger child
            ...
            // if top's key is bigger than or equal to the largerChild's key,
            // then no need to go down any more
            // duplicate keys are allowed in heaps
            ...
            // index goes down toward the largerChild
            index = largerChild;
        }

        // finally, insert the top node into the right position
        heapArray[index] = top;
    }
