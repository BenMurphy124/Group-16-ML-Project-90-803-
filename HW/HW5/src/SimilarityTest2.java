 ...
 * Homework Assignment 5 Document Similarity Acceptance Test (case 2).
 *
...
public class SimilarityTest2 {
    ...
    public static void main(String[] args) {
        Similarity file1 = new Similarity(new File("/Users/alexjiang/Library/Mobile Documents/com~apple~CloudDocs/CMU/course/Data Structure/HW/HW5/src/greatexpectations.txt"));
        printOutput(file1);

        Similarity file2 = new Similarity(new File("/Users/alexjiang/Library/Mobile Documents/com~apple~CloudDocs/CMU/course/Data Structure/HW/HW5/src/twocities.txt"));
        printOutput(file2);
