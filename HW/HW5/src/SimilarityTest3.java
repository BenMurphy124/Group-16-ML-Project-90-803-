...
public class SimilarityTest3 {
    ...
    public static void main(String[] args) {
        Similarity file1 = new Similarity(new File("/Users/alexjiang/Library/Mobile Documents/com~apple~CloudDocs/CMU/course/Data Structure/HW/HW5/src/warpeace.txt"));
        printOutput(file1);

        Similarity file2 = new Similarity(new File("/Users/alexjiang/Library/Mobile Documents/com~apple~CloudDocs/CMU/course/Data Structure/HW/HW5/src/clarissa.txt"));
        printOutput(file2);
