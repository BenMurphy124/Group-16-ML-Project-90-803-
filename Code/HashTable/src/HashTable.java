 ...
 * Module 12 HashTable Implementation.
 *
 * Assumption: It takes only positive unique integers.
 * For the sake of simplicity, there are only keys, like HashSet.
 *
...
public class HashTable implements HashTableInterface {
     ...
     * We will look into this aspect further later in next module.
