 ...
 * Module 14 Advanced Sorting
 *
 * Naive version of Merge Sort.
 * Needs some optimizations; you will have a chance to work on it in lab 5.
 *
 * @author Terry Lee
 */
public class MergeSort {
    ...
    public static int[] mergeSort(int[] unsorted) {
        ...
        // recursive case
        // divide into two halves (literally)
    ...
    public static void main(String[] args) {
        ...
        // more realistic test of merge sort with random values
        ...
        // just to make sure sorting really works
        // add "-ea" vm argument
